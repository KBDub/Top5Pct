                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="pb-2 border-b border-linen-dark">
                                        ...
                                        <div class="grid grid-cols-3 gap-x-4 gap-y-3">
                                            ...
                                            <div><a href="/signs/ground-signs/sidewalk-signs-a-frame-signs" class="block text-lg font-bold text-charcoal hover:text-sunburst transition-colors text-center">A-Frame &amp; Sidewalk Signs</a><a href="/signs/ground-signs/sidewalk-signs-a-frame-signs" class="block text-base text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">A-frame &amp; sidewalk signs</a></div>
                                        </div>
                                    </div>
                                    {{-- Row 3: Table Signs --}}
                                    <div>
        ...
        <div class="max-w-7xl mx-auto px-4 py-4 space-y-1">
            ...
            <div>
                ...
                <div x-show="openMobile === 'signs'" x-transition class="pl-4 pt-1 pb-2 space-y-1 border-l-2 border-sunburst ml-3">
                    ...
                    <a href="/signs/ground-signs/sidewalk-signs-a-frame-signs" class="block px-3 py-1.5 text-sm text-charcoal hover:text-sunburst">A-Frame &amp; Sidewalk Signs</a>
