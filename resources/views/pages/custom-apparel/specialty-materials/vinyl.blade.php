...
<x-layouts.page
    ...
    <x-sections.top5pct-same-day-service
        ...
        trustNote="Same day vinyl shirts are available on most orders — call us and we will confirm your turnaround before you come in."
    />
    ...
    >
        ...
        <x-slot name="lower">
            ...
            <p class="mb-4">Heat transfer vinyl comes in an enormous range of colors including standard solids, neons, pastels, metallics, glitter, holographic, flock, and more. That variety lets you match brand colors precisely, create eye-catching event shirts in neon shades, or add a premium sparkle finish similar to what our <a href="/custom-apparel/printing-options/rhinestone-apparel" class="link-notification">rhinestone apparel</a> team produces with heat-set crystals. Most specialty vinyl options are available at a modest upcharge over standard smooth vinyl, so you can offer something special without a dramatic cost increase, and our <a href="/design-services/logo-design" class="link-notification">design team</a> will recommend the right color and finish for your project.</p>
