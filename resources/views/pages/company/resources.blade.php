            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <a href="/blog/custom-t-shirt-tips" class="group block bg-linen hover:bg-linen-dark transition-colors">
                    <div class="overflow-hidden">
                        <img src="/images/screen-printing/top5pct-screenprinting-joliet.jpg" alt="7 tips for ordering custom t-shirts from Top 5 Percent in Joliet Illinois" class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300" loading="lazy" />
                    </div>
                    <div class="p-6">
                ...
                <a href="/blog/buy-stickers-decals-joliet" class="group block bg-linen hover:bg-linen-dark transition-colors">
                    <div class="overflow-hidden">
                        <img src="/images/custom-shaped-stickers-decals/top5pct-custom-stickers.jpg" alt="Where to buy custom stickers in Joliet Illinois" class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300" loading="lazy" />
                    </div>
                    <div class="p-6">
                ...
                <a href="/blog/window-wall-signs" class="group block bg-linen hover:bg-linen-dark transition-colors">
                    <div class="overflow-hidden">
                        <img src="/images/wall-signs/top5pct-wall-signs-mishas-gaming-lounge.jpg" alt="Window and wall sign tips for businesses in Joliet Illinois" class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300" loading="lazy" />
                    </div>
                    <div class="p-6">
                ...
                <a href="/blog/car-wraps-vinyl-lettering" class="group block bg-linen hover:bg-linen-dark transition-colors">
                    <div class="overflow-hidden">
                        <img src="/images/automobile-graphics/top5pct-car-wraps.jpg" alt="Car wraps and vinyl lettering for vehicles in Joliet Illinois" class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300" loading="lazy" />
                    </div>
                    <div class="p-6">
                ...
                <a href="/blog/corporate-wear-guide" class="group block bg-linen hover:bg-linen-dark transition-colors">
                    <div class="overflow-hidden">
                        <img src="/images/corporate-wear/top5pct-custom-business-shirts.jpg" alt="Corporate wear and branded uniforms for businesses in Joliet Illinois" class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300" loading="lazy" />
                    </div>
                    <div class="p-6">
                ...
                <a href="/blog/spirit-wear-tips" class="group block bg-linen hover:bg-linen-dark transition-colors">
                    <div class="overflow-hidden">
                        <img src="/images/spirit-wear/top5pct-spirit-wear-shirts.jpg" alt="Spirit wear and fan apparel for schools and sports teams in Joliet Illinois" class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300" loading="lazy" />
                    </div>
                    <div class="p-6">
